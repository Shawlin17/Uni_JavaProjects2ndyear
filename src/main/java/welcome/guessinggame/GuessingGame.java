...
public class GuessingGame {
    ...
    public static String Guess(int GamerAnswer, int SecretNumber, int count){
        ...
        if (GamerAnswer <=0 || GamerAnswer >100) {
         ...
         else if (GamerAnswer > SecretNumber-extra && GamerAnswer < SecretNumber){
           return "Your guess is low but in range 5, try again.\nTry Number: " + count;
        }
         else if (GamerAnswer < SecretNumber+extra && GamerAnswer > SecretNumber){
           return "Your guess is high but in range 5, try again.\nTry Number: " + count;
        }
        else if (GamerAnswer > SecretNumber) {
